...
export default function MultiStep(props) {
    ...
    const submit = () => setStepState(compState)
    ...
    const renderNav = (show) =>
        show && (
            <div>
                <button className='btn btn-secondary me-2 px-5'
                ...
                <button className='btn btn-secondary me-2 px-5' data-bs-toggle="modal" data-bs-target="#Sellersuccess"
                    style={buttonsState.showSubmitBtn ? props.submitStyle : { display: 'none' }}
                    onClick={submit}
                >
                    Submit
                </button>
    ...
    return (
        <div>
            <Ol className='d-none'>{renderSteps()}</Ol>
