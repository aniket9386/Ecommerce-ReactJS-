...
export default function ForgotPassword() {
    ...
    return (
        <>
            <div className="modal fade" id="ForgotModalToggle" aria-hidden="true" aria-labelledby="ForgotModalToggleLabel" tabIndex="-1">
                                    ...
                                    <div className="d-flex justify-content-center form_container">
                                        <form>
                                            ...
                                            <div className="d-flex justify-content-center mt-3 login_container">
                                                <button type="button" name="button" className="btn login_btn">Reset</button>
                                            </div>
                                        </form>
                                    </div>
